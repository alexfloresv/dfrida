<?php
class FunctionCategoriaProductos
{
  ...
  //botones Clientes
  public static function getBtnCatProductos($codCatPro)
  {
    $botones = '
    <button class="btn btn-warning btnEditCatProd" codCatPro="' . $codCatPro . '" ><i class="fa-solid fa-pencil"></i></button>
    <button class="btn btn-danger btnDeleteCatProd" codCatPro="' . $codCatPro . '" ><i class="fa-solid fa-trash"></i></button>
    ';
    return $botones;
  }
}
