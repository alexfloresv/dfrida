<?php
class FunctionCategoriaProductosMprima
{
  ...
  //botones Clientes
  public static function getBtnCategoriaMprima($codCatProMp)
  {
    $botones = '
    <button class="btn btn-warning btnEditCatProdMp" codCatProMp="' . $codCatProMp . '" ><i class="fa-solid fa-pencil"></i></button>
    <button class="btn btn-danger btnDeleteCatProdMp" codCatProMp="' . $codCatProMp . '" ><i class="fa-solid fa-trash"></i></button>
    ';
    return $botones;
  }
}
