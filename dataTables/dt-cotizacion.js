...
// funcionalidad para data table para modal  de categorias de productos crear y eliminar registros sina ctualizar la pagina
document.addEventListener("DOMContentLoaded", function () {
  //verrificar si la ruta es la correcta
  var currentPath = window.location.pathname;
  ...
  if (currentPath == appPath) {
    //si es correcta la ruta inicializa el datatable
    $("#modalCrearPedido").on("click", "#verCotizacionesPedidoAdd", function () {
      // Verifica si el DataTable ya está inicializado y destrúyelo si es así
      if (
