...
class almacenProductosController
{
  ...
  {
    $table = "ingreso_prod";
    $response = almacenProductosModel::mdlVerProductosIngresadosModal($table, $codAllIngProd);
    return $response;
  }
  ...
  public static function ctrIngresarProductosAlmacenProd($jsonProductosIngProd)
  {
    ...
    foreach ($dataProductosCotizacion as $producto) {
      ...
      if ($stockAlmacen === false) {
        ...
        $response = almacenProductosModel::mdlIngresarProductosAlmacenProd($table, $dataIngAlamacen);
      } else {
        ...
        $response = almacenProductosModel::mdlSumarProductoAlmacenProd($table, $dataSumarProdAlamacen);
      }
  ...
  {
    $table = "almacen_prod";
    $response = almacenProductosModel::mdlStockAlmacen($table, $codProd);
    return $response;
  }
  ...
  public static function ctrRegistroIngresoProductos($IngresoProdData, $jsonProductosCotizacion)
  {
    ...
    $response = almacenProductosModel::mdlCrearIngresoProd($table, $dataCreate);
  ...
  public static function ctrEditProduct($editarProducto)
  {
    if (isset($editarProducto['editProductName']) && isset($editarProducto['editProductCategory'])) {
      ...
      $response = almacenProductosModel::mdlEditProduct($table, $dataUpdate);
      return $response;
    }
  }
  // Eliminar cotizacion
  public static function ctrDeleteCotizacion($borrarCotizacion)
  {
    ...
    $table = "cotizacion";
    $response = almacenProductosModel::mdlDeleteCotizacion($table, $codCoti);
  ...
  {
    $table = 'producto';
    $response = almacenProductosModel::mdlAgregarIngProducto($table, $codIngProducto);
    return $response;
  }
  ...
  public static function ctrDescargarPdfCotizacion($codCotiPdf)
  {
    ...
    $table = "cotizacion";
    $response = almacenProductosModel::mdlDescargarPdfCotizacion($table, $codCoti);
  ...
  {
    $table = "cotizacion";
    $response = almacenProductosModel::mdlEstadoDescargaPdfCotizacion($table, $codCoti);
    return $response;
  }
}
