...
//tipo proc 1
    ...
    foreach ($dataProductosSalida as $producto) {
      ...
      if ($stockAlmacen === false) {
        ...
        foreach ($operacionesExitosas as $operacion) {
          procesoOperativoModel::mdlRestaurarProductosAlmacenProd($table, $operacion);
        }
        ...
        $response = procesoOperativoModel::mdlRestarProductoAlmacenProd($table, $dataRestarProdAlamacen);
        if (!$response) {
  ...
  {
    $table = "almacen_prod";
    $response = procesoOperativoModel::mdlStockAlmacen($table, $codProd);
    return $response;
  }
  ...
  public static function ctrRegistroSalidaProductos($salidaProdData, $jsonProductosSalidaProd)
  {
    ...
    $response = procesoOperativoModel::mdlCrearSalidaProd($table, $dataCreate);
    return $response;
  }
  ...
  public static function ctrVerDataIngProductos($codSalProd)
  {
    ...
    $table = "salida_prod";
    $response = procesoOperativoModel::mdlVerDataSalidaRegistro($table, $codIdSalProd);
    return $response;
  }
  ...
  public static function ctrStockAlmacenEdit($codIngProd)
  {
    ...
    $table = "almacen_prod";
    $response = procesoOperativoModel::mdlStockAlmacenEdit($table, $codIdIngProd);
    return $response;
  }
  ...
  public static function ctrEditarSalidaProd($editarSalProd, $jsonEditarSalProductosForms)
  {
    ...
    if ($_SESSION["idTipoUsu"] == 1) {
      ...
      $response = procesoOperativoModel::mdlEditarSalidaProd($table, $dataUpdate);
    } else {
      $response = "error";
    }
    return $response;
  ...
  public static function ctrEditarProductosRetiradosAlmacen($jsonProdSalAnteriorEdit, $jsonEditarSalProductosForms)
  {
    ...
    foreach ($dataSumaAlmacen as $producto) {
      ...
      $response = procesoOperativoModel::mdlActualizarProductosIngresados($table, $dataActualizarProdAlamacen);
    }
  ...
  public static function ctrBorrarSalProductos($borrarSalProductos)
  {
    ...
    if ($_SESSION["idTipoUsu"] == 1) {
      ...
      $response = procesoOperativoModel::mdlBorrarRegistroIngresProducto($table, $codSalProd);
    } else {
      $response = "error";
    }
    return $response;
  ...
  public static function ctrRecuperarProductosRegSalida($codSalProd)
  {
    ...
    $response = procesoOperativoModel::mdlRecuperarProductosRegSalida($table, $codSalProd);
    return $response;
  }
  ...
  {
    $table = "almacen_prod";
    $response = procesoOperativoModel::mdlStockAlmacenSalida($table, $codProd);
    return $response;
  }
  ...
  {
    $table = 'almacen_prod';
    $response = procesoOperativoModel::mdlAgregarSalProducto($table, $codSalProducto);
    return $response;
  }
